...
○ Original Form
   ...
   01) initialDelay : 최초 지연 시간 조절
   02) period : 데이터를 재발행하기 까지 쉬는 시간 조절
   04) @SchedulerSupport(SchedulerSupport.COMPUTATION)
...
public class Rx_05_01_Interval implements RxTest {
	...
	public static void main(String[] args) { 
		Rx_05_01_Interval test = new Rx_05_01_Interval();
		test.marbleDiagram();
	}
